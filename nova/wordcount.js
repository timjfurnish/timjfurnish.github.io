g_tabFunctions['word tally'] = function(reply, thenCall)
{
	...
	reply.push('</select>')
	reply.push('&nbsp;&nbsp;<INPUT TYPE="checkbox" onChange="RedrawWordTable()" id="displayUnique"><LABEL FOR="displayUnique"> Display words/phrases only used once</LABEL>')
	reply.push('&nbsp;&nbsp;<INPUT TYPE="checkbox" checked onChange="RedrawWordTable()" id="stopAtApostrophe"><LABEL FOR="stopAtApostrophe"> Trim words at an apostrophe</LABEL>')
	reply.push('<BR>')
